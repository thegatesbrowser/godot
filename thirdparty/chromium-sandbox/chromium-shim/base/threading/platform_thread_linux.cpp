...
// Chromium 137 declares the map as size 7 in platform_thread_internal_posix.h
// but only ships six initializers in platform_thread_linux.cc (the trailing
// slot stays zero-initialized after kCompositing was dropped). Match that
// shape — declaring size 6 here would conflict with the extern declaration.
